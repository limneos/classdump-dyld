...
-(void)setEstimatedTravelTime:(double)arg1 fromOrigin:(SCD_Struct_Se2)arg2 transportType:(unsigned)arg3 ;
-(void)addAttribution:(id)arg1 info:(id)arg2 ;
-(SCD_Struct_Se2)_offsetCoordinate:(float)arg1 ;
...
-(BOOL)canDropAPin;
-(BOOL)shouldUpdateEstimatedTravelTimeForNewOrigin:(SCD_Struct_Se2)arg1 transportType:(unsigned)arg2 ;
...
-(BOOL)isEstimatedTravelTimeValidForOrigin:(SCD_Struct_Se2)arg1 transportType:(unsigned)arg2 ;
