...
@property (assign,nonatomic) SCD_Struct_MN29 arrowMetrics;                             //@synthesize arrowMetrics=_arrowMetrics - In the implementation block
